...
static const char *fonts[]               = { 
  "JetBrainsMono Nerd Font:size=13:antialias=true:autohint=true:style=Bold",
  "Noto Color Emoji:size=13:antialias=true:autohint=true:style=Bold",
  "Noto Sans CJK JP:size=13:antialias=true:autohint=true:style=Bold",
  "Noto Sans CJK KR:size=13:antialias=true:autohint=true:style=Bold",
  "Noto Sans CJK SC:size=13:antialias=true:autohint=true:style=Bold",
};
...
static char selfgcolor[]                 = "#eff1f5";
static char selbgcolor[]                 = "#f38ba8";
static char selbordercolor[]             = "#f38ba8";
static char selfloatcolor[]              = "#f38ba8";

static char titlenormfgcolor[]           = "#cdd6f4";
static char titlenormbgcolor[]           = "#1e1e2e";
static char titlenormbordercolor[]       = "#cba6f7";
static char titlenormfloatcolor[]        = "#cba6f7";

static char titleselfgcolor[]            = "#1e1e1e";
static char titleselbgcolor[]            = "#f38ba8";
static char titleselbordercolor[]        = "#f38ba8";
static char titleselfloatcolor[]         = "#f38ba8";

static char tagsnormfgcolor[]            = "#cdd6f4";
static char tagsnormbgcolor[]            = "#1e1e2e";
static char tagsnormbordercolor[]        = "#cba6f7";
static char tagsnormfloatcolor[]         = "#cba6f7";

static char tagsselfgcolor[]             = "#1e1e1e";
static char tagsselbgcolor[]             = "#f38ba8";
static char tagsselbordercolor[]         = "#f38ba8";
static char tagsselfloatcolor[]          = "#f38ba8";
...
static const Rule rules[] = {
  ...
  RULE(.title = "Steam - News", .isfloating = 1)
  RULE(.title = "Network Connections", .isfloating = 1)
	#if RENAMED_SCRATCHPADS_PATCH
